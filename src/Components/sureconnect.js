...
const SureConnect = (props) => 
{
    ...
    const surerequest = useSelector(state => state.root.sureconnect);
        ...
        <div>
            ...
            <div className="profilecontainer"> 
              ...
              <div className="list-group">
                  {
                      surerequest != null &&
                      Object.keys(surerequest).length > 0 &&
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-7 col-sm-7 col-md-7 col-8 content">
                                    <div className="news-content">
                                        <p style={{textTransform:'capitalize'}}>{surerequest.user.name}</p>
                                        <p style={{fontSize:14}}>NGN {surerequest.requestAmount.toLocaleString()}</p>
                                        <div className="news-meta">
                                            <a href="#" className="post-author">Min Interest Rate {surerequest.minInterestRate}%</a>
                                        </div>
                                        <div className="news-meta">
                                            <a href="#" className="post-date">  Max Interest Rate {surerequest.maxInterestRate}%</a> 
                                        </div>
                                ...
                                <div className="col-lg-3 col-sm-12 col-md-3">
                                       ...
                                       <button  name="submit" className="viewdetail" onClick ={() => ViewborrowerProfile(surerequest)} type="submit"   id="" data-submit="...Sending">View Details</button>
                    ...
                    <div hidden = {(surerequest != null && Object.keys(surerequest).length == 0 && IsFetching == false) ? false: true}>
...
export default withRouter(SureConnect);