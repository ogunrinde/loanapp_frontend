...
import {  GetBorrowerAllLoansRequest, ResearchforLender, SetPaymentSchedules } from '../redux/action/index';
import { Tab, Tabs, TabList, TabPanel } from 'react-tabs';
import 'react-tabs/style/react-tabs.css';
import BorrowerPaymentSchedules from './borrower_payment_schedules';

const BorrowerRequestList = (props) => 
{
    ...
    {
        setview_more(true);
        //await dispatch(SetPaymentSchedules());
        setrequest(request);
    ...
    return(
        <section className="lattest-product-area pb-40 category-list">
            <ReactNotification />
                <div hidden={!view_more} className="sideview2" style={{padding:9}}>
                    ...
                    <div className="" style={{width:'100%'}}>
                        <div id="">
                        { Object.keys(request).length > 0 && <BorrowerPaymentSchedules request = {request} />   }
                        ...
                        <tbody>
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                      ...
                                      <button onClick = {() => requestInformation(request)} style={{padding:3,color:'#fff',background:'linear-gradient(90deg, #ffba00 0%, #ff6c00 100%)',borderRadius:3}}>View Payment Schedules</button>
...
export default withRouter(BorrowerRequestList);