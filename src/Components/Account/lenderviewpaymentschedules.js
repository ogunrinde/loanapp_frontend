...
import {  GetLoansDisbursed, requeststatus } from '../redux/action/index';
import { Tab, Tabs, TabList, TabPanel } from 'react-tabs';
import 'react-tabs/style/react-tabs.css';
import LenderPaymentSchedules from './lender_payment_schedules';

const LenderDisbursedList = (props) => 
{
        ...
        <section className="lattest-product-area pb-40 category-list">
            <ReactNotification />
                <div hidden={!view_more} className="sideview2" style={{padding:9}}>
                    ...
                    <div className="">
                        <div id="">
                        { Object.keys(request).length > 0 && <LenderPaymentSchedules request = {request} />   }
                    ...
                    <table className="table">
                        ...
                        <tbody>
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button onClick = {() => requestInformation(request)} style={{padding:3,color:'#fff',background:'linear-gradient(90deg, #ffba00 0%, #ff6c00 100%)',borderRadius:2}}>View Payment Schedules</button>
...
export default LenderDisbursedList;