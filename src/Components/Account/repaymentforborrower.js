...
import {  GetborrowersLoansDisbursed } from '../redux/action/index';
import { Tab, Tabs, TabList, TabPanel } from 'react-tabs';
import 'react-tabs/style/react-tabs.css';
import Request from './Request';
import StepWizard from 'react-step-wizard';
import BorrowerRepaymentlist from '../Account/BorrowerRepaymentlist';
import BorrowerRepaymentOrder from './BorrowerRepaymentOrder';



const RepaymentforBorrower = (props) => 
{
	const dispatch = useDispatch();
    //const repayments = useSelector(state => state.root.repayments_borrower);
    const loansreceived = useSelector(state => state.root.loansreceived);
    ...
    const process = async  () =>
    {
        ...
        await dispatch(GetborrowersLoansDisbursed());
        //alert(JSON.stringify(loansreceived));
        setIsFetching(false);
    }
    ...
    return(
        ...
        <ReactNotification />
            ...
            <StepWizard>
                <BorrowerRepaymentlist loansdisbursed ={loansreceived} />
                <BorrowerRepaymentOrder />
            </StepWizard>
...
export default RepaymentforBorrower;